...
class AutoDetectMediaLibrarySsl_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'auto-detect-media-library-ssl'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'auto-detect-media-library-ssl'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'auto-detect-media-library-ssl'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'auto-detect-media-library-ssl'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'auto-detect-media-library-ssl');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'auto-detect-media-library-ssl'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'auto-detect-media-library-ssl');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'auto-detect-media-library-ssl'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'auto-detect-media-library-ssl') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'auto-detect-media-library-ssl');
            case 'false':
                return __('false', 'auto-detect-media-library-ssl');

            case 'Administrator':
                return __('Administrator', 'auto-detect-media-library-ssl');
            case 'Editor':
                return __('Editor', 'auto-detect-media-library-ssl');
            case 'Author':
                return __('Author', 'auto-detect-media-library-ssl');
            case 'Contributor':
                return __('Contributor', 'auto-detect-media-library-ssl');
            case 'Subscriber':
                return __('Subscriber', 'auto-detect-media-library-ssl');
            case 'Anyone':
                return __('Anyone', 'auto-detect-media-library-ssl');
        }
        return $optionValue;
    }
